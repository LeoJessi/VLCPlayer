...
public class VLCOptions {
    ...
    public static ArrayList<String> getLibOptions(Context context) {
        ...
        String chroma = pref.getString("chroma_format", "RV16");// RGB 32 位: 默认色度 RGB 16 位: 性能更佳，但画质下降 YUV:
        // 性能最佳，但并非所有设备可用。仅限 Android 2.3 及更高版本。
...
//        options.add("0");//这里太大了消耗性能   太小了会花屏*/
        ...
        options.add("--avcodec-skiploopfilter");
        options.add("4");// 4不去块 (最快) 0完全去块 (最慢)
